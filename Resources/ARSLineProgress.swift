...
final public class ARSLineProgressConfiguration: NSObject {
    ...
    public static var circleColorOuter: CGColor = UIColor.ars_colorWithRGB(218.0, green: 158.0, blue: 159.0, alpha: 1.0).CGColor
    public static var circleColorMiddle: CGColor = UIColor.ars_colorWithRGB(218.0, green: 86.0, blue: 80.0, alpha: 1.0).CGColor
    public static var circleColorInner: CGColor = UIColor.ars_colorWithRGB(218.0, green: 74.0, blue: 68.0, alpha: 1.0).CGColor
